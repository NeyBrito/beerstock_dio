...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Ney Brito";
    private static final String CONTACT_GITHUB = "https://github.com/NeyBrito";
    private static final String CONTACT_EMAIL = "ney.brito@etec.sp.gov.br";
